...
if(isset($_POST['sub'])){
    ...
    $sql0=$DB->prepare("INSERT INTO login(name,password) VALUES (:idata0,:idata1) ");
...
<body>
  <div class="login">
    ...
    <form method="post" action="index.php">
      ...
      <p class="submit"><input type="submit" name="sub" value="Login" ><a href="account.php"></a></p>
       
        <a href="add.php">Please create An Account HERE?</a>
    </form>
  </div>
